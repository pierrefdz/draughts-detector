The project was done as a part of a Computer Vision course, and the goal was to apply the methods learned in the lectures. Here, we use feature extraction, clustering methods and some other algorithms to get information from a chessboard picture. The full report is available in the pdf file. 
